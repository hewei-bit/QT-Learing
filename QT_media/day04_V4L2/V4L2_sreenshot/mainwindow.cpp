    ...
    ui(new Ui::MainWindow),bufrgb(nullptr)
{
    ...
    connect(&timer,&QTimer::timeout,this,&LED::flushButff);
...
void LED::on_startBtn_2_clicked()
{
...
void LED::on_startBtn_3_clicked()
{
    //打开数据库
...
void LED::on_listWidget_itemDoubleClicked(QListWidgetItem *item)
{
